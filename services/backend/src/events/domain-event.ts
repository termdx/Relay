...
export const GITLAB_PUSH = 'gitlab.push';
export const GITLAB_MR_OPENED = 'gitlab.mr_opened';
export const GITLAB_MR_MERGED = 'gitlab.mr_merged';
export const GITLAB_MR_CLOSED = 'gitlab.mr_closed';
export const GITLAB_ISSUE_OPENED = 'gitlab.issue_opened';
export const GITLAB_ISSUE_CLOSED = 'gitlab.issue_closed';
export const BITBUCKET_PUSH = 'bitbucket.push';
export const BITBUCKET_PR_OPENED = 'bitbucket.pr_opened';
export const BITBUCKET_PR_MERGED = 'bitbucket.pr_merged';
export const BITBUCKET_PR_DECLINED = 'bitbucket.pr_declined';
